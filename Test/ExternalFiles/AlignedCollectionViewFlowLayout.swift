...
//    func setUPClv() {
//        tagsClv.delegate = self
//        tagsClv.dataSource = self
//        tagsClv.register(UINib(nibName: "TagCell", bundle: nil), forCellWithReuseIdentifier: "TagCell")
//        let flowLayout = tagsClv?.collectionViewLayout as? AlignedCollectionViewFlowLayout
